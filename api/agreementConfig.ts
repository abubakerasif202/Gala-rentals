...
const DEFAULT_LEASE_OWNER_NAME = 'Maple Rentals Pty Ltd';
const DEFAULT_LEASE_OWNER_ADDRESS = 'Sydney NSW, Australia';
const DEFAULT_LEASE_OWNER_CONTACT = '0420 550 556';
const DEFAULT_LEASE_OWNER_EMAIL = 'hello@maplerentals.com.au';
