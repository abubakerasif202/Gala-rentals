...
Stripe System V3 is the current Maple Rentals Stripe architecture. It preserves the V2 correctness guarantees while making checkout orchestration thinner, webhook processing queue-ready, and replay/debug behavior easier to operate under load.
