...
- Gala workflow rules from repo instructions and memory: admin review before payment, checkout is payment-only, manual vehicle text remains primary.

## Brand Summary

Gala Rentals is a premium Sydney vehicle rental business with a SaaS-style operations layer. The current brand language is dark navy, warm gold, white/silver public surfaces, vehicle photography, high letter spacing, rounded panels, and precise operational copy.
...
- `assets/` contains copied Gala logos and vehicle imagery used by the prototype.
...
3. Admin approves vehicle text, bond, weekly price, and start date.
