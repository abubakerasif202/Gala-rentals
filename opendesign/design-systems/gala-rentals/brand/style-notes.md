...
- White panels should be used for public trust, vehicle cards, and high-readability admin metric cards.
...
- Public pages: generous sections, large vehicle imagery, clear CTA rows, trust panels.
